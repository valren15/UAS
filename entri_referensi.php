...
<div id="sidebar"><a href="entri_referensi.php" class="visible-phone"><i class="icon icon-tasks"></i> <span>Entri Referensi</span></a>
  ...
  ?>
    ...
    <li class="active"> <a href="entri_referensi.php"><i class="icon icon-tasks"></i> <span>Pilih Restoran</span></a> </li>
...
<!--Action boxes-->
  <div class="container-fluid">
    ...
    ?>
      <div class="widget-box">
        <div class="widget-title bg_lg"><span class="icon"><i class="icon-th-large"></i></span>
          <h5>Restoran Padang Sederhana</h5>
          <a href="tambah_menu.php" class="btn btn-info btn-mini label"><i class="icon-plus"></i>&nbsp;Tambah Data</a>
        </div>
        <div class="widget-content" >
          <ul class="thumbnails">
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Restaurant <a href="#">by kelompok5</a> </div>
</div>
